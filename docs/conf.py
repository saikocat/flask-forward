...
project = u'Flask-Forward'
copyright = u'2013, Nguyen Duc Hoa'
...
htmlhelp_basename = 'Flask-Forwarddoc'
...
latex_documents = [
  ('index', 'Flask-Login.tex', u'Flask-Forward Documentation',
   u'Nguyen Duc Hoa', 'manual'),
]
...
man_pages = [
    ('index', 'flask-forward', u'Flask-Forward Documentation',
     [u'Nguyen Duc Hoa'], 1)
]
